...
async def check_settings():
    ...
    print(f"  Detection Confidence: {insightface_face_service.detection_confidence}")
    print(f"  Recognition Model: {insightface_face_service.face_recognition_model}")
    
    # Reload settings
    insightface_face_service._load_settings()
